...
impl Session {
    ...
    fn revogar(&self) -> u64 {
        ...
        // **A revogação nativa encerra os executores dela**, sem esperar a
        // janela pedir. A diretriz é explícita, e a razão é que a janela pode
