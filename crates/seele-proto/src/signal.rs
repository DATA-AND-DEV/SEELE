...
/// (`comp v2`) bands the same number in three, at 85 and
...
impl SignalBand {
    /// Which band a ratio falls into. `comp v2`.
    #[must_use]
...
mod tests {
    ...
    fn the_bands_break_where_the_comp_breaks_them() {
        // comp v2: >= 85 fósforo, 60-85 laranja,
