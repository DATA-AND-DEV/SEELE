//! Characterises the network profiles in [`magi_audio::netsim`].
//!
...
//!
//! Run with: `cargo run --release --package magi-audio --example netsim_profiles`

use magi_audio::netsim::{run, ArrivedFrame, NetworkProfile};
