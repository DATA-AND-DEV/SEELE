...
//!
//! ADR 0044. This is where MODs stop being a laboratory: until here nothing
...
//! the thread the audio path shares. ADR 0044 wrote "MOD code never touches the
...
pub struct Resposta {
    ...
    /// Who failed, and how. ADR 0044: a MOD that throws is disabled and the
    /// room continues.
...
///
/// **Disables it, and the room continues** — ADR 0044, "falha isolada". The
...
mod tests {
    ...
    /// **A garantia central do ADR 0044:** um MOD que quebra é desabilitado e a
