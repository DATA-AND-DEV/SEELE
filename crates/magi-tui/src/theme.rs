...
//!
//! The values come from `design/magi-tokens.json`, frozen in task M0.12. That
...
mod tests {
    ...
    fn the_values_match_the_frozen_tokens() {
        // design/magi-tokens.json is the source; this is the translation. A
