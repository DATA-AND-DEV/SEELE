...
//! its own language. `crates/magi-proto/src/lib.rs` states the intent: nothing
...
use magi_core::{AlertReason, DisconnectReason};
...
///
/// The internal battery reconnects on its own (`specs/04-servidor-magi.md`), and
