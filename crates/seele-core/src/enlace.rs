...
///   IPv6 é o firewall do roteador, e furar NAT não abre firewall — isso é o PCP
///   da pendência nº 26. Avisar por um candidato IPv6 gastaria janela do
...
mod quem_precisa_de_furo {
    ...
    /// 0037. Não há tradução de endereço: o que bloqueia um IPv6 é o firewall do
    /// roteador, e furar NAT não abre firewall. Avisar por um candidato IPv6
    /// gasta janela do anfitrião — sessenta por dez segundos — por um caminho que
    /// o aviso não ajuda.
    ///
