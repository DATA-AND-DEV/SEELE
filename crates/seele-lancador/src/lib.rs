...
//!
//! **Aviso de numeração:** nesta base a decisão do launcher é o ADR **0045** e
//! a dos MODs é o **0044**; na `main` integrada elas são **0046** e **0045**,
//! porque um ADR próprio da `main` entrou antes das duas. O texto da decisão é
//! o mesmo. Ver a nota no topo de `docs/versoes-lado-a-lado.md`.
//!
//! [ADR 0045](../../../docs/adr/0045-toda-versao-continua-de-pe.md) decidiu que
