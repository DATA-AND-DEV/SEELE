//! O manifesto de versões — o `latest.json` depois do ADR 0046.
//!
//! O ADR 0046 diz duas coisas sobre este arquivo, e as duas foram mantidas:
...
//! trancaria fora exatamente as instalações antigas que o ADR 0046 promete
...
/// instalado — e o ADR 0046 diz que isso é caro.
...
///
/// ADR 0046: «cliente, servidor, protocolo e API de MOD sobem juntos e são
...
/// versões já instaladas, que é exatamente o que o ADR 0046 promete não fazer
...
mod testes {
    ...
    /// estão instaladas, que é a promessa do ADR 0046.
    #[test]
