...
| `pos_armado2_1` | restaurada | disco e paginação | 0 | volta a passar |

**A ressalva, escrita onde ela mora.** A reprovação de volta não saiu na forma
literal pedida pelo aceite (`--workspace`, ~20 s): saiu em
`-p seele-conformance` e por um prazo de 5 s. A §29 explica o porquê — o que
