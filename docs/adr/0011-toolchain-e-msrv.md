...
Alternativas: declarar uma MSRV baixa (ex. 1.85) para compatibilidade ampla. Descartado porque SEELE é **aplicação**, não biblioteca: nenhum consumidor externo compila estes crates, e `specs/00-visao-geral.md` registra cliente de terceiros como não-objetivo. MSRV baixa custaria trabalho real sem beneficiar ninguém.
...
Revisar se `seele-proto` algum dia for publicado para consumo de terceiros.
