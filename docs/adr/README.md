...
| [0044](0044-mods-o-produto-base-tem-regras-e-um-mod-nao.md) | MODs: o produto base tem regras, e um MOD não | **proposto** | — (pedido do dono; substitui o `0029`) |
| [0045](0045-toda-versao-continua-de-pe.md) | Toda versão continua de pé: o app vira launcher | **proposto** | — (pedido do dono; substitui o botão do `0026`) |
