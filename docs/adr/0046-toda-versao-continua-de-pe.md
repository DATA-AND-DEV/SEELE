# ADR 0046 — Toda versão continua de pé: o app vira launcher

**Estado:** proposto
**Data:** 2026-09-05

> **Esta página nasceu como 0045 e foi renumerada na integração**, junto com o
> [0045](0045-mods-o-produto-base-tem-regras-e-um-mod-nao.md), que nasceu 0044.
> O motivo está lá: a `main` aceitou um 0044 próprio enquanto `desenho/mods`
> escrevia o dele. Commits e conversas de antes de 2026-09-09 dizem «ADR 0045»
> querendo dizer esta página.
...
Esta decisão existe por causa do [ADR 0045](0045-mods-o-produto-base-tem-regras-e-um-mod-nao.md),
...
É o que permite ao ADR 0045 abandonar a camada de compatibilidade dentro do
...
1. **Só a fachada congelada do ADR 0045, sem multi-versão.** Um número próprio
...
da API congelada do ADR 0045 — a promessa é o produto, não a implementação dela.
