# ADR 0045 — MODs: o produto base tem regras, e um MOD não

**Estado:** proposto
**Data:** 2026-09-05

> **Esta página nasceu como 0044 e foi renumerada na integração**, junto com o
> 0046. Enquanto ela era escrita em `desenho/mods`, a `main` aceitou o seu
> próprio [0044](0044-o-portao-divide-a-subida-medida.md) — dois ramos que
> saíram do mesmo ponto e não se viram. Quem renumera é o proposto, e não o
> aceito, pela regra que o `README.md` desta pasta já dava para os renomes: um
> número publicado é endereço de quem aponta para ele de fora.
>
> Commits e conversas de antes de 2026-09-09 dizem «ADR 0044» querendo dizer
> esta página.
...
dependia do significado antigo. É para esse dia que o **ADR 0046** existe.
...
- **Remoção alcança quem já baixou**, e é a mesma peça da revogação de versões do
  [ADR 0046](0046-toda-versao-continua-de-pe.md).
