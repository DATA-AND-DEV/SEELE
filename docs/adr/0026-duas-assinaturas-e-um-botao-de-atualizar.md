...
Status: aceito — **o botão foi substituído pelo [ADR 0046](0046-toda-versao-continua-de-pe.md)** em 2026-09-05

> **As duas assinaturas continuam valendo inteiras** e viraram pré-requisito do
> 0046. O que saiu foi «um app, uma versão instalada»: o botão de atualizar vira
