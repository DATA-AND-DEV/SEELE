...
O daemon se chama `magid`. Uma instância é um **Dogma Central**. Internamente, três subsistemas nomeados — não é decoração: são fronteiras reais de módulo, e o estado de cada um aparece nas telas de diagnóstico do cliente.
...
[persistencia]
caminho = "/var/lib/magid/dogma.db"
