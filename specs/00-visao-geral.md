...
**SEELE** é um servidor de voz e texto auto-hospedado. O cliente principal, **SEELE** (`connection`), roda inteiramente no terminal. Há clientes gráficos para desktop e mobile que compartilham o mesmo núcleo.
